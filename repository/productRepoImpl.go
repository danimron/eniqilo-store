...
func (repository *ProductRepositoryImpl) Delete(ctx context.Context, tx *sql.Tx, productId int) error {
...
func (repository *ProductRepositoryImpl) Update(ctx context.Context, tx *sql.Tx, product domain.Products) error {
...
func (repository *ProductRepositoryImpl) FindAll(ctx context.Context, db *sql.DB, sql string) ([]domain.Products, error) {
